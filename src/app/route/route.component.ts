...
resturents: Array<any> = [];
  ...
  constructor(private getLocationService: GetLocationService, private spinner: NgxSpinnerService, private activatedRoute: ActivatedRoute, private route: ActivatedRoute, private modalService: NgbModal, config: NgbRatingConfig) {
    ...
    const words: string = this.activatedRoute.snapshot.params.travelName
...
deleteTrip(item) {
console.log(item);
const index = this.placesToShow.indexOf(item);
